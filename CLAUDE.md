...
Each phase has a default orchestration mode — interactive for planning phases (human-in-the-loop conversation), parallel for building phases (autonomous artifact-driven execution). See `methodology/orchestration-modes.md` for full mode definitions.
